...
trait DatabasesBase
{
    ...
    public function testCreateDocument(array $data): array
    {
        ...
        $res = $this->client->call(Client::METHOD_PUT, "/vectordb/{$databaseId}/collections/{$collectionId}/documents/{$documentId}", [
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ], [
        ...
        $this->assertContains($res['headers']['status-code'], [200, 201]);
        ...
        $badVec = [1.0, 0.0];
        $bad = $this->client->call(Client::METHOD_PUT, "/vectordb/{$databaseId}/collections/{$collectionId}/documents/" . ID::unique(), [
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ], [
        ...
        $strVec = ['1.0', '0.0', '0.0'];
        $bad2 = $this->client->call(Client::METHOD_PUT, "/vectordb/{$databaseId}/collections/{$collectionId}/documents/" . ID::unique(), [
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ], [
        ...
        $res2 = $this->client->call(Client::METHOD_PUT, "/vectordb/{$databaseId}/collections/{$collectionId}/documents/{$documentId2}", [
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ], [
        ...
        $this->assertContains($res2['headers']['status-code'], [200, 201]);
    ...
    public function testUpsertDocument(array $data): array
    {
        ...
        $this->assertContains($upd['headers']['status-code'], [200, 201]);
    ...
    public function testUpdateDocument(array $data): array
    {
        ...
        $this->assertContains($upd2['headers']['status-code'], [200, 201]);
    ...
    public function testDocumentsVectorQueries(array $data): array
    {
        ...
        $mk = function(array $vec, string $name) use ($databaseId, $collectionId) {
            $id = ID::unique();
            $this->client->call(Client::METHOD_PUT, "/vectordb/{$databaseId}/collections/{$collectionId}/documents/{$id}", [
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
                'x-appwrite-key' => $this->getProject()['apiKey']
            ], [
        ...
        $vA = array_fill(0, 1536, 0.0); $vA[0] = 1.0; // close to [1,0,0,...]
        $vB = array_fill(0, 1536, 0.0); $vB[1] = 1.0; // close to [0,1,0,...]
    ...
    public function testDocumentPermissions(array $data): void
    {
        ...
        $docId = ID::unique();
        $vector = array_fill(0, 1536, 0.0); $vector[0] = 1.0;
        $create = $this->client->call(Client::METHOD_PUT, "/vectordb/{$databaseId}/collections/{$collectionId}/documents/{$docId}", [
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ], [
        ...
        $this->assertContains($create['headers']['status-code'], [200, 201]);

        // Attempt to GET as guest (no key) should fail with 401 due to missing scopes
    ...
    public function testVectorInvalidValues(): void
    {
        ...
        $badPayloads = [
            ...
            (function(){ $v=[]; $v[0]=1.0; $v[2]=1.0; return ['embeddings'=>$v]; })(),
        ];
