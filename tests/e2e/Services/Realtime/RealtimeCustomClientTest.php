...
class RealtimeCustomClientTest extends Scope
{
    ...
    /**
     * General complexity -> O(Bulk_Documents * Connections)
     * 1. Worst cases ->
     *      a. Each document is having permission for different user. Means a doc specifically with permission of userid
     *      b. Each document is having read:all permission
